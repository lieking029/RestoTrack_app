...
class _$CartItemModelImpl extends _CartItemModel {
  ...
  @override
  String toString() {
    return 'CartItemModel(menuId: $menuId, name: $name, unitPrice: $unitPrice, quantity: $quantity, notes: $notes)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, menuId, name, unitPrice, quantity, notes);
...
abstract class _CartItemModel extends CartItemModel {
  const factory _CartItemModel(
      ...
      final String? notes}) = _$CartItemModelImpl;
