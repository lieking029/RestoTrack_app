      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Role: ${user.primaryRole.toUpperCase()}', style: Theme.of(context).textTheme.bodyMedium),
            const SizedBox(height: 24),
            Expanded(
              child: Center(
                child: ElevatedButton.icon(
                  onPressed: () {
                    // TODO: Navigate to KDS
                  },
                  icon: const Icon(Icons.kitchen, size: 32),
                  label: const Text('Open Kitchen Display', style: TextStyle(fontSize: 18)),
