...
/// @nodoc
mixin _$MenuState {
  List<MenuModel> get menuItems => throw _privateConstructorUsedError;
  List<MenuModel> get filteredItems => throw _privateConstructorUsedError;
...
class _$MenuStateImpl extends _MenuState {
  const _$MenuStateImpl(
      {final List<MenuModel> menuItems = const [],
      final List<MenuModel> filteredItems = const [],
  ...
  @override
  String toString() {
    return 'MenuState(menuItems: $menuItems, filteredItems: $filteredItems, categories: $categories, isLoading: $isLoading, isSearching: $isSearching, selectedCategoryId: $selectedCategoryId, searchQuery: $searchQuery, errorMessage: $errorMessage)';
  }
...
abstract class _MenuState extends MenuState {
  const factory _MenuState(
      ...
      final List<MenuModel> filteredItems,
